...
export async function deleteSection(songId: string, sectionId: string): Promise<void> {
    const url = `${BASE_URL}/songs/${songId}/sections/${sectionId}`
    console.log('deleting section at:', url)
